...
uchar	i, j;
    ...
    DDRB = 	0b00000000;       /* all pins input */
    PORTD =	0b11110010;   /* 1111 0010 bin: activate pull-ups except on USB lines */
    DDRD =	0b00001111;    /* 0000 1101 bin: all pins input except USB (-> USB reset) */
	j = 0;
